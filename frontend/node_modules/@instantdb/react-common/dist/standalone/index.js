...
var Vs = (n, e, t) => e in n ? zs(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var p = (n, e, t) => Vs(n, typeof e != "symbol" ? e + "" : e, t);
import kr, { useRef as ke, useCallback as Ae, useSyncExternalStore as St, useEffect as je, useMemo as Gt, useState as Cr } from "react";
var Ht = { exports: {} }, He = {};
/**
 * @license React
...
function Bs() {
  ...
  return n.NODE_ENV !== "production" && function() {
    ...
    var E = Object.assign, M = 0, R, q, W, O, k, U, z;
    function G() {
    }
    ...
    function re() {
      {
        if (M === 0) {
          R = console.log, q = console.info, W = console.warn, O = console.error, k = console.group, U = console.groupCollapsed, z = console.groupEnd;
          var d = {
            configurable: !0,
            enumerable: !0,
            value: G,
...
` + j[H].replace(" at new ", " at ");
        ...
        Rt = !1, be.current = N, Be(), Error.prepareStackTrace = L;
      }
    ...
    function js(d, w, A, C, L) {
      {
        ...
        A !== void 0 && (Mn(A), j = "" + A), Cs(w) && (Mn(w.key), j = "" + w.key), ks(w) && (se = w.ref, Is(w, L));
        for (N in w)
        ...
        return Rs(d, j, se, L, C, Rn.current, D);
      }
    }
...
function Ke(n, e, t, r, s) {
  ...
  switch (xe(n)) {
    case 2:
      ...
      n.set = n.clear = n.delete = Vn;
      break;
    case 3:
      for (const a of n)
        Ke(a, a, t, r, s);
      n.add = n.clear = n.delete = Vn;
      break;
    case 1:
      Object.freeze(n);
      let o = 0;
...
const vt = (n, e, t = !1) => {
...
}, ri = Reflect.ownKeys(Xt), Qn = (n, e, { isValuesIterator: t }) => () => {
  var r, s;
  const i = e.next();
  if (i.done)
    return i;
  ...
  values() {
    ...
    return {
      ...
      next: Qn(n, e, { isValuesIterator: !0 })
    };
  },
  entries() {
    const n = $(this);
...
const si = Reflect.ownKeys(At), jr = /* @__PURE__ */ new WeakSet(), $r = {
  get(n, e, t) {
    var r, s;
...
function oi(n, e) {
  ...
  return [
    a,
    (c = []) => {
      const [u, l, f] = ii(a, c, s, i, e.enableAutoFreeze);
...
function xr(n) {
  ...
  if (_n(s, (o, a) => {
    ...
    return yn(o) ? new Set(s) : new (Object.getPrototypeOf(o)).constructor(s);
  }
  return s;
}
function Bn(n) {
...
function Lr(n, e) {
  ...
  if (t in n) {
    ...
    Lr(n[t], r), ui(n[t]) && delete n[t];
  }
}
function ui(n) {
  return n && Object.keys(n).length === 0;
}
const Jn = /ZULU|YEKT|YEKST|YAPT|YAKT|YAKST|XJT|WGT|WGST|WFT|WETDST|WET|WDT|WAT|WAST|WAKT|WADT|VUT|VOLT|VLAT|VLAST|VET|UZT|UZST|UYT|UYST|UTC|UT|ULAT|ULAST|UCT|TVT|TRUT|TOT|TMT|TKT|TJT|TFT|TAHT|SGT|SCT|SAST|SADT|RET|PYT|PYST|PWT|PST|PONT|PMST|PMDT|PKT|PKST|PHT|PGT|PETT|PETST|PET|PDT|OMST|OMSST|NZT|NZST|NZDT|NUT|NST|NPT|NOVT|NOVST|NFT|NDT|MYT|MVT|MUT|MUST|MST|MSK|MSD|MPT|MMT|MHT|MEZ|METDST|MET|MESZ|MEST|MDT|MAWT|MART|MAGT|MAGST|LKT|LINT|LIGT|LHST|LHDT|KST|KRAT|KRAST|KOST|KGT|KGST|KDT|JST|JAYT|IST|IRT|IRKT|IRKST|IOT|IDT|ICT|HST|HKT|GYT|GMT|GILT|GFT|GET|GEST|GAMT|GALT|FNT|FNST|FKT|FKST|FJT|FJST|FET|EST|EGT|EGST|EETDST|EET|EEST|EDT|EAT|EAST|EASST|DDUT|DAVT|CXT|CST|COT|CLT|CLST|CKT|CHUT|CHAST|CHADT|CETDST|CET|CEST|CDT|CCT|CAST|CADT|BTT|BST|BRT|BRST|BRA|BOT|BORT|BNT|BDT|BDST|AZT|AZST|AZOT|AZOST|AWST|AWSST|AST|ART|ARST|ANAT|ANAST|AMT|AMST|ALMT|ALMST|AKST|AKDT|AFT|AEST|AESST|AEDT|ADT|ACWST|ACT|ACST|ACSST|ACDT$/, li = {
  ZULU: 0,
  YEKT: 18e3,
  YEKST: 21600,
  YAPT: 36e3,
...
function vi(n) {
  ...
  if (!e)
    return null;
  const [t] = e, r = li[t], s = new Date(n.replace(Jn, "Z"));
...
function Ei(n) {
  try {
    ...
    return typeof e == "string" ? tn(e) : null;
  } catch {
    return null;
  }
}
...
function Kr(n, e) {
  return et(n, e.triples, e.cardinalityInference, e.useDateObjects);
}
function qr(n, e) {
  if (n)
...
function zr(n, e, t) {
  ...
  return a && (o = a[3]), o || Date.now() * 10 + Ii++;
}
function Vr(n, e, t) {
  const r = at(n, t);
  if (!r)
...
function Hr(n, e, t) {
  return t ? typeof n == "object" ? Vi(n) ? t : null : Wi(n)(n, e, t) : null;
}
function Qi(n, e, t) {
...
function Bi(n, e, t) {
  return Ji(n, e, t).map((r) => Qi(e, r, t)).filter((r) => r);
}
function Gi(n, e, t) {
  return e.or ? e.or.patterns.flatMap((r) => rn(n, r, t)) : e.and ? e.and.patterns.reduce((r, s) => rn(n, s, r), t) : t.flatMap((r) => Bi(n, e, r));
}
function rn(n, e, t = [{}]) {
  return e.reduce((r, s) => Gi(n, s, r), t);
}
function An(n, e) {
  return Array.isArray(e) ? e.map((t) => An(n, t)) : Ki(e) ? n[e] : e;
}
function Hi(n, { find: e, where: t }) {
  return rn(n, t).map((s) => An(s, e));
}
function Ji(n, e, t) {
  return Di(n, An(t, e));
}
const Yi = /^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-8][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000|ffffffff-ffff-ffff-ffff-ffffffffffff)$/i;
function ze(n) {
...
const to = typeof crypto < "u" && crypto.randomUUID && crypto.randomUUID.bind(crypto), Zn = { randomUUID: to };
function no(n, e, t) {
  var s;
  if (Zn.randomUUID && !n)
    return Zn.randomUUID();
  n = n || {};
  const r = n.random ?? ((s = n.rng) == null ? void 0 : s.call(n)) ?? eo();
  if (r.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return r[6] = r[6] & 15 | 64, r[8] = r[8] & 63 | 128, Zi(r);
}
function Xn(n) {
...
function sn(n, e, t, r, s, i) {
  const o = s.slice(0, s.length - 1), a = s[s.length - 1], [c, u, l] = bo(n, e, t, r, o), f = yo(n, e, c, u, a, i);
  return l.concat([f]);
}
function go(n, e) {
...
function rr(n, e, t, r, s) {
  return To(s).map((i) => sn(n, e, t, r, i, {
    $isNull: !0
  }));
}
...
function So(n, e, t, r) {
  const s = It;
  return r ? Yr(s, n, e, t, r).concat(er(s, n, e, t)) : er(s, n, e, t);
}
function vo(n, e, t) {
  return [n(e, t), n("time", t)];
}
function Ao(n, e, t, r, s, i) {
  const [o, a, c, u, l] = Jr(n, e, t, r, s), f = ho(c, n(t, r), i);
  return [o, a, f, u, l];
}
function Oo(n, e, t, { etype: r, level: s, form: i }, o) {
...
function Eo(n, e, t) {
  return t === "string" ? ao(n, e) : n > e ? 1 : -1;
}
function tt(n, e, t, r, s) {
  return e === r || e == null && r == null ? so(n, t) : r == null ? 1 : e == null ? -1 : Eo(e, r, s);
}
...
function Zr(n, e, t) {
  ...
  const [a, c] = t, u = e["checked-data-type"], l = u === "date" ? on(c) : c, f = u === "date" ? on(i) : i;
  return Et([a, l], [r, f], u);
}
function ko(n, e, t, r) {
  const s = Zr(n, e, r);
...
function jo(n, e, { etype: t, pageInfo: r, dq: s, form: i }) {
  ...
  for (const S of u) {
    const [g] = S;
    if (y[g] || !a && l && h && ko(l, h, c, S) || f && h && Co(f, h, c, S))
      continue;
    const m = Ui(n, b, g);
    m && (y[g] = m);
  }
...
function ts({ store: n, attrsStore: e, pageInfo: t, aggregate: r }, s) {
  ...
  return t && (o.pageInfo = Uo(t)), r && (o.aggregate = r), o;
}
function Lo() {
  const e = {
    __etype: 1,
...
function Ko(n) {
  return new Proxy({
    ...
    get(e, t) {
      if (t === "lookup")
        return (s, i) => Tt(n, an(No(s, i)), []);
      if (t === "__etype")
        return n;
      const r = t;
      return kt(r) ? Tt(n, an(r), []) : Tt(n, r, []);
    }
  });
}
function On() {
...
function sa(n, e, t) {
  ...
  const { unique: s, indexed: i } = r == null ? void 0 : r.config, o = ra(r == null ? void 0 : r.valueType);
  return {
    "index?": i,
    "unique?": s,
    "checked-data-type": o
...
const aa = /* @__PURE__ */ new Set(["create", "update", "merge", "link", "unlink"]), ca = /* @__PURE__ */ new Set(["link", "unlink"]), ua = /* @__PURE__ */ new Set(["create", "update", "merge"]), la = /* @__PURE__ */ new Set([
  "link",
  "unlink",
  "create",
  "update",
...
function pa(n, e) {
  const r = (Array.isArray(e) ? e : [e]).flatMap((c) => qo(c)), [s, i] = ha(n, r), o = { ...n, attrsStore: s }, a = r.flatMap((c) => na(o, c));
  return [...i, ...a];
}
function ir(n, e) {
...
class fn {
  ...
  async _initMeta() {
    ...
    try {
      const t = this._persister.getItem(qe);
  ...
  _writeToStorage(e) {
    ...
    for (const f of i) {
      ...
      t.push(h.then(() => 1)), this._loadedKeys.delete(f), this._pendingSaveKeys.delete(f);
    }
    const a = [], c = [[qe, s]], u = s.objects ?? {};
    s.objects = u;
    for (const f of o)
  ...
  async clearUnloadedKeys() {
    ...
    for (const t of await this._persister.getAllKeys())
      t === qe || t in this.currentValue || (this._pendingSaveKeys.add(t), e = !0);
...
async function Ta(n, e) {
  const t = await ma(`instant_${n}_5`);
  if (!t)
    return;
...
class ss extends ya {
  constructor(t, r) {
    ...
    p(this, "_prefix");
    p(this, "_dbPromise");
    this.dbName = `instant_${t}_${ba}`, this._storeName = r, this._appId = t, this._dbPromise = this._init();
  }
  _init() {
    return new Promise((t, r) => {
      let s = !1;
      ...
      i.onerror = (o) => {
        ...
        if (s) {
          ...
          ar.set(this.dbName, u), u.then(() => t(c)).catch(() => t(c));
        } else {
          const u = ar.get(this.dbName);
...
async function Ca({ apiURI: n, appId: e, path: t, file: r, refreshToken: s, contentType: i, contentDisposition: o }) {
  const a = {
    app_id: e,
    path: t,
...
let En = !1, os = !1, as = !1;
typeof window < "u" && typeof window.localStorage < "u" && (En = !!window.localStorage.getItem("devBackend"), os = !!window.localStorage.getItem("__instantLogging"), as = !!window.localStorage.getItem("__devtoolLocalDash"));
function ur(n, e) {
  if (!e)
    return n;
  const t = {};
...
function ja(n, e, t) {
  ...
  if (e && "user" in e ? e.user : !0) {
    const i = ur(n.user ?? {}, e == null ? void 0 : e.keys);
    r.user = { ...i, peerId: t };
  }
  for (const i of Object.keys(n.peers ?? {})) {
    ...
    if (o || a) {
      const c = ur(n.peers[i], e == null ? void 0 : e.keys);
...
function $a(n, e) {
  if (n.isLoading !== e.isLoading || n.error !== e.error || (n.user || e.user) && (!n.user || !e.user || !Gn(n.user, e.user)) || !Dr(n.peers, e.peers))
    return !0;
  for (const r of Object.keys(n.peers))
    if (!Gn(n.peers[r], e.peers[r]))
      return !0;
  return !1;
}
class lr {
...
const hr = [
  ...
  "fields",
  "aggregate"
], Da = (n) => n.valueType || "unknown", ls = (n, e, t = !1) => {
  if (t || n == null)
    return !0;
  switch (e) {
    case "string":
  ...
  for (const [s, i] of Object.entries(n)) {
    ...
    if (s === "id") {
      We(i, "id", new ve("string", !1, !0), e, `${r}.id`);
      continue;
    }
    if (s.includes(".")) {
      La(s, i, e, t, `${r}.${s}`);
...
const hs = (n) => n.length > 0 ? n.join(", ") : "none", Na = (n, e) => new ye(`Entity '${n}' does not exist in schema. Available entities: ${hs(e)}`), Nt = {
  ...
  if (!t)
    throw Na(n, Object.keys(e.entities));
  return t;
}, Kt = (n, e, t) => {
  const r = ps(n, t);
...
function Ya(n, e, t) {
  ...
  if (n.orderField === "serverCreatedAt") {
    t.sort(n.orderDirection === "asc" ? function(o, a) {
      return tt(o.entity.id, o.serverCreatedAt, a.entity.id, a.serverCreatedAt, r);
    } : function(o, a) {
      return tt(a.entity.id, a.serverCreatedAt, o.entity.id, o.serverCreatedAt, r);
    });
    return;
  }
  const s = n.orderField;
  t.sort(n.orderDirection === "asc" ? function(o, a) {
    return tt(o.entity.id, o.entity[s], a.entity.id, a.entity[s], r);
  } : function(o, a) {
    return tt(a.entity.id, a.entity[s], o.entity.id, o.entity[s], r);
  });
}
var Ie;
(function(n) {
...
class Za {
  constructor(e, t, r, s, i, o) {
    ...
    p(this, "createStore");
    p(this, "getAttrs");
    this.trySend = e, this.config = r, this.log = s, this.createStore = i, this.getAttrs = o, this.subs = new fn({
      persister: t,
      merge: Ga,
      serialize: Ba,
      parse: (a, c) => Qa(c, this.config.useDateObjects),
      objectSize: (a) => {
        var c;
  ...
  async initSubscription(e, t, r) {
    ...
    if (s && s.state && s.state.txId) {
      this.sendResync(s, s.state, s.state.txId), (u = s.values) != null && u.entities && r && r({
        ...
        data: yt(s, (l = s.values) == null ? void 0 : l.entities)
      });
      return;
    }
  ...
  onSyncLoadBatch(e) {
    ...
    for (const u of r) {
      ...
      c.push({
        store: l,
        entity: f,
        serverCreatedAt: _r(o, l, a.attrsStore, f.id)
      }), i.push(f);
    }
  ...
  onSyncInitFinish(e) {
    ...
    s && this.notifyCbs(r, {
      ...
      data: yt(s, ((i = s.values) == null ? void 0 : i.entities) || [])
    });
  }
...
function tc({ RStream: n, opts: e, startStream: t, cancelStream: r }) {
          ...
          if (ee.body) {
            ...
            try {
              for (; ; ) {
                ...
                let M = E;
                if (I > 0 && (M = E.subarray(I), I -= E.length - M.length), !M.length)
                  continue;
                s += M.length;
                const R = o.decode(M);
                m.enqueue(R);
...
class nc {
  ...
  createWriteStream(e) {
    const { stream: t, addCompleteCb: r } = Xa({
  ...
  createReadStream(e) {
    const { stream: t, addCloseCb: r } = tc({
...
function cc({ transportType: n, appId: e, apiURI: t, wsURI: r, EventSourceImpl: s }) {
  ...
  switch (n) {
    case "ws":
      return new gr(`${r}?app_id=${e}`);
    case "sse":
      return new Va(s, `${t}/runtime/sse?app_id=${e}`);
    default:
...
class yc {
  constructor(e, t = ss, r = is, s, i) {
    ...
    p(this, "pushTx", (e) => {
      this.config.disableValidation || za(e, this.config.schema);
      try {
        const t = pa({
    ...
    if (this._EventSource = i, this.config = { ...ac, ...e }, this.queryCacheLimit = this.config.queryCacheLimit ?? 10, this._pendingTxCleanupTimeout = this.config.pendingTxCleanupTimeout ?? sc, this._pendingMutationCleanupThreshold = this.config.pendingMutationCleanupThreshold ?? ic, this._log = xa(e.verbose || En || os, () => this._reactorStats()), this.versions = { ...s || {}, "@instantdb/core": us }, this.config.schema && (this._linkIndex = dr(this.config.schema)), !!uc()) {
      if (!e.appId)
      ...
      })), this._initStorage(t), this._syncTable = new Za(this._trySendAuthed.bind(this), new t(this.config.appId, "syncSubs"), {
        useDateObjects: this.config.useDateObjects
      }, this._log, (o) => et(this.ensureAttrs(), o, this.config.enableCardinalityInference, this.config.useDateObjects), () => this.ensureAttrs()), this._instantStream = new nc({
  ...
  _initStorage(e) {
    this.querySubs = new fn({
      persister: new e(this.config.appId, "querySubs"),
      merge: pc,
      serialize: fc,
      parse: (t, r) => lc(r, this.config.useDateObjects),
      // objectSize
      objectSize: (t) => {
        var r, s, i;
    ...
    }), this.querySubs.onKeyLoaded = (t) => this._onQuerySubLoaded(t), this.kv = new fn({
    ...
    }, this.kv.waitForKeyToLoad("pendingMutations"), this.kv.waitForKeyToLoad(Fe), this._beforeUnloadCbs.push(() => {
  ...
  _handleReceive(e, t) {
    ...
    switch (wr[t.op] || this._log.info("[receive]", e, t.op, t), t.op) {
      case "init-ok": {
      ...
      case "refresh-ok": {
        ...
        const S = Vt(T.entries()), g = y.map((m) => {
          var Q, E, M, R;
          const P = m["instaql-query"], v = m["instaql-result"], I = Z(P), x = fr(v), F = this.ensureAttrs(), V = et(F, x, r, this.config.useDateObjects), { store: fe, attrsStore: we } = this._applyOptimisticUpdates(V, F, S, _), ee = (E = (Q = v == null ? void 0 : v[0]) == null ? void 0 : Q.data) == null ? void 0 : E["page-info"], te = (R = (M = v == null ? void 0 : v[0]) == null ? void 0 : M.data) == null ? void 0 : R.aggregate;
          return {
            q: P,
            hash: I,
            store: fe,
...
`, e.hint);
  ...
  queryOnce(e, t) {
    this.config.disableValidation || pr(e, this.config.schema), t && "ruleParams" in t && (e = { $$ruleParams: t.ruleParams, ...e });
    const r = new lr();
    if (!this._isOnline)
  ...
  _trySend(e, t, r) {
    if (this._transport.isOpen()) {
      switch (wr[t.op] || this._log.info("[send]", this._transport.id, t.op, {
        "client-event-id": e,
        ...t
      }), t.op) {
        case "transact": {
  ...
  async _oauthLoginInit() {
    ...
    try {
      ...
      const f = await this._getCurrentUser(), h = (f == null ? void 0 : f.type) === "guest", { user: y } = await cr({
        apiURI: this.config.apiURI,
        appId: this.config.appId,
        code: r,
  ...
  async setCurrentUser(e) {
    this.kv.updateInPlace((t) => {
      t[Fe] = e;
    }), await this.kv.waitForKeyToLoad(Fe);
  }
  ...
  async _getCurrentUser(e) {
    e != null && e.forceReadFromStorage && await this.kv.unloadKey(Fe);
    const t = await this.kv.waitForKeyToLoad(Fe);
  ...
  async _hasCurrentUser() {
    const e = await this.kv.waitForKeyToLoad(Fe);
  ...
  async signInWithMagicCode(e) {
    var i, o;
    const t = await this.getCurrentUser(), r = ((i = t == null ? void 0 : t.user) == null ? void 0 : i.type) === "guest", s = await va({
      apiURI: this.config.apiURI,
      appId: this.config.appId,
      email: e.email,
      code: e.code,
  ...
  async exchangeCodeForToken({ code: e, codeVerifier: t, extraFields: r }) {
    var a, c;
    const s = await this.getCurrentUser(), i = ((a = s == null ? void 0 : s.user) == null ? void 0 : a.type) === "guest", o = await cr({
      apiURI: this.config.apiURI,
      appId: this.config.appId,
      code: e,
      codeVerifier: t,
  ...
  async signInWithIdToken(e) {
    var i;
    const t = await this.getCurrentUser(), r = (i = t == null ? void 0 : t.user) == null ? void 0 : i.refresh_token, s = await Ea({
      apiURI: this.config.apiURI,
      appId: this.config.appId,
      idToken: e.idToken,
  ...
  _notifyPresenceSub(e, t) {
    ...
    r && (t.prev && !$a(r, t.prev) || (t.prev = r, t.cb(r)));
  }
  ...
  async upload(e, t) {
    var c;
    const r = await this.getCurrentUser(), s = (c = r == null ? void 0 : r.user) == null ? void 0 : c.refresh_token, i = e || t.name, o = await Pa({
      apiURI: this.config.apiURI,
      appId: this.config.appId,
      fileName: i,
      refreshToken: s
...
function bc(n, e) {
  gt == null || gt.dispose();
  const t = Sc(e), r = mc(e, a), s = _c(gc(n));
  function i(l) {
    var f;
    l.source === s.element.contentWindow && ((f = l.data) == null ? void 0 : f.type) === "close" && t.isVisible() && a();
  }
  function o(l) {
    const f = l.shiftKey && l.ctrlKey && l.code === "Digit0", h = l.key === "Escape" || l.key === "Esc";
    (f || h && t.isVisible()) && a();
  }
  function a() {
...
function gc(n) {
  return `${En || as ? "http://localhost:3000" : "https://instantdb.com"}/_devtool?appId=${n}`;
}
function _c(n) {
...
const vc = (n) => JSON.stringify(n), nt = (n, e = !1) => JSON.stringify([n, e]), Tr = (n) => {
  const [e, t] = JSON.parse(n);
  return { cursor: e, afterInclusive: t };
}, Ne = (n, e, t = !1) => `${n}:${nt(e, t)}`, Ac = (n) => !!n.endCursor, Oc = (n) => {
  var t;
...
}, bs = (n) => n && Object.keys(n).length > 0 ? n : {
  serverCreatedAt: "asc"
}, Ec = (n, e) => {
  const t = [
  ...
  const T = (E) => {
    ...
    u.set(nt(E, M.afterInclusive), M), S();
  }, m = (E, M) => {
    l.set(nt(E), M), F(), S();
  }, P = (E, M) => {
    var O, k;
    const { cursor: R } = Tr(E), q = f.get(Ne("reverse", R));
    q == null || q();
    const W = n.subscribeQuery({
      ...
      Ye(z && G, "Expected query subscription to contain rows and pageInfo"), m(R, {
        data: z,
        status: "frozen",
    ...
    f.set(Ne("forward", E, M), R);
  }, x = (E, M = !1) => {
    var k, U;
    const R = nt(E, M), q = f.get(Ne("forward", E, M));
    q == null || q();
    const W = u.get(R);
    ...
    if (!(R != null && R.hasMore) || !Ac(R))
      return;
    const q = `${M}:${vc(R.endCursor)}`;
    q != b && (b = q, P(M, R), v(R.endCursor));
  }, V = () => {
    ...
    if (!R.endCursor)
      return;
    const { cursor: q, afterInclusive: W } = Tr(M);
    x(q, W), I(R.endCursor);
  };
  return _ = n.subscribeQuery({
    ...
    if (E.error)
      return T(E.error);
    const M = E.pageInfo[a], R = (W = E == null ? void 0 : E.data) == null ? void 0 : W[a];
    if (Ye(R && M, "Expected rows and pageInfo"), R.length < o) {
      g(Qt, {
        data: R,
    ...
    u.delete(nt(Qt)), I(q, !0), v(M.startCursor), h = !0;
  }, r), {
    unsubscribe: () => {
      if (y) {
        y = !1, _ == null || _(), _ = null;
  ...
  const { entityName: r, entityQuery: s } = gs(e), i = ((u = s.$) == null ? void 0 : u.limit) || 10, o = bs((l = s.$) == null ? void 0 : l.order);
  let a = e ? _s({
    [r]: {
      ...s,
      $: {
        ...
        fields: (h = s.$) == null ? void 0 : h.fields,
        order: o
      }
    }
  }) : null;
...
class xc {
  ...
  shutdown() {
    delete hn[dn(this._reactor.config)], this._reactor.shutdown();
  }
  /**
...
function Uc(n, e, t, r, s) {
  ...
  }, e || ss, t || is, { ...r || {}, "@instantdb/core": us }, s), c = new xc(a);
  return hn[dn(i)] = c, Lc(i.appId, i.devtool), c;
}
function Lc(n, e) {
  ...
  t.allowedHosts.includes(window.location.hostname) && bc(n, t);
}
const Or = {
  isLoading: !0,
  data: void 0,
...
function Kc({
  ...
  const r = ke(null), s = Z(e), i = Z(t), o = Cc(n, e, t), a = ke({
    ...
    (f) => {
      ...
      const h = n.subscribeInfiniteQuery(
        e,
        (y) => {
          a.current = {
            ...y,
      ...
      return r.current = h, () => {
        h.unsubscribe(), r.current === h && (r.current = null);
      };
    },
    [s, i]
  );
...
function Qc(n, e = {}) {
  ...
  je(() => n.core._reactor.subscribePresence(
    n.type,
    n.id,
    e,
    (u) => {
  ...
  const r = qc(), s = Pe.usePresence(n, {
    ...
    (l) => {
      n.core._reactor.publishPresence(n.type, n.id, {
        [e]: l
      }), l && ((t == null ? void 0 : t.timeout) === null || (t == null ? void 0 : t.timeout) === 0 || r.set((t == null ? void 0 : t.timeout) ?? Wc, () => {
        n.core._reactor.publishPresence(n.type, n.id, {
          [e]: null
        });
      }));
    ...
    o(!1);
  }, [o]), u = Gt(() => ({ onKeyDown: a, onBlur: c }), [a, c]);
  return {
    active: i,
    setActive: o,
    inputProps: u
...
class Hc {
  constructor(e, t, r) {
     ...
     */
    p(this, "useSyncPresence", (e, t) => Pe.useSyncPresence(this, e, t));
    /**
     * @deprecated
     ...
     */
    p(this, "useTypingIndicator", (e, t = {}) => Pe.useTypingIndicator(this, e, t));
...
class Bt {
  constructor(e, t) {
     ...
     *   );
     */
    p(this, "useQuery", (e, t) => Fc(this.core, e, t).state);
    /**
     * Listen for the logged in state. This is useful
     * for deciding when to show a login screen.
     *
     ...
     * });
     */
    p(this, "useInfiniteQuery", (e, t) => Kc({
      core: this.core,
      query: e,
      opts: t
    }));
...
p(Bt, "Store"), p(Bt, "NetworkListener"), p(Bt, "EventSourceImpl");
export {
  Bt as InstantReactAbstractDatabase,
  Fc as useQueryInternal
};
