...
function createServiceWithConfig(configOverride) {
    jest.resetModules();
    jest.doMock('../../config', () => ({
        __esModule: true,
...
describe('WhatsAppService outbound provider routing', () => {
    ...
    describe('meta-only advanced sends', () => {
        ...
        test('sendInteractiveButtons returns not supported when provider=greenapi', async () => {
            ...
            const result = await service.sendInteractiveButtons('+919876543210', 'Body', [{ id: 'a', title: 'A' }], null, null, {
                phoneNumberId: '',
                accessToken: '',
                verifyToken: '',
            });
        ...
        test('sendInteractiveList returns not supported when provider=greenapi', async () => {
            ...
            const result = await service.sendInteractiveList('+919876543210', 'Body', 'Button', [{ title: 'Section', rows: [{ id: 'row', title: 'Row' }] }], null, null, {
                phoneNumberId: '',
                accessToken: '',
                verifyToken: '',
            });
...
//# sourceMappingURL=whatsapp-service.provider-routing.test.js.map