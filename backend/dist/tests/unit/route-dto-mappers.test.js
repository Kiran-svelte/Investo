...
const visit_routes_1 = require("../../routes/visit.routes");
describe('route DTO mappers', () => {
    it('maps lead fields to snake_case including date fields', () => {
        ...
        expect((0, lead_routes_1.mapLeadToSnakeCaseDTO)(lead)).toEqual({
            id: 'lead-1',
            customer_name: 'Asha',
            phone: '+919876543210',
            email: 'asha@example.com',
    ...
    it('maps property fields to snake_case including media and dates', () => {
        ...
        expect((0, property_routes_1.mapPropertyToSnakeCaseDTO)(property)).toEqual({
            id: 'property-1',
            name: 'Green Acres',
            builder: 'Acme',
            location_city: 'Pune',
    ...
    it('keeps zero latitude/longitude values in property DTO mapping', () => {
        ...
        const dto = (0, property_routes_1.mapPropertyToSnakeCaseDTO)(property);
    ...
    it('maps visit fields to snake_case for calendar API', () => {
        ...
        const dto = (0, visit_routes_1.mapVisitToSnakeCaseDTO)({
            id: 'visit-1',
            companyId: 'co-1',
            leadId: 'lead-1',
            propertyId: 'prop-1',
...
//# sourceMappingURL=route-dto-mappers.test.js.map