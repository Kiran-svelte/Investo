...
function expectNoRawPhoneInLoggerMetadata() {
...
describe('WhatsAppService inbound operational behavior', () => {
    ...
    it('persists inbound message and updates lead contact details', async () => {
        ...
        expect(mockEmitToCompany).toHaveBeenCalledWith('company-1', 'conversation.updated', expect.objectContaining({
            conversationId: 'conv-1',
            leadId: 'lead-1',
...
//# sourceMappingURL=whatsapp.inbound-processing.test.js.map