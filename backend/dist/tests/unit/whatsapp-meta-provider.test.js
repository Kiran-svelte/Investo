...
const meta_whatsapp_provider_1 = require("../../services/whatsapp/providers/meta-whatsapp.provider");
const mockFetch = jest.fn();
global.fetch = mockFetch;
describe('MetaWhatsAppProvider (outbound)', () => {
    const apiUrl = 'https://graph.facebook.com/v18.0';
    const provider = new meta_whatsapp_provider_1.MetaWhatsAppProvider({ apiUrl });
    const companyConfig = {
...
//# sourceMappingURL=whatsapp-meta-provider.test.js.map