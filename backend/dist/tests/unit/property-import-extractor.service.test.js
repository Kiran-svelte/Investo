...
const propertyImportExtractor_service_1 = require("../../services/propertyImportExtractor.service");
describe('PropertyImportExtractorService', () => {
    ...
    test('parses brochure pdf text and returns structured extraction data', async () => {
        ...
        const extractor = new propertyImportExtractor_service_1.PropertyImportExtractorService({
            fetch: fetchMock,
            pdfParse: async () => ({
                text: [
                    'Sunrise Residences',
...
//# sourceMappingURL=property-import-extractor.service.test.js.map