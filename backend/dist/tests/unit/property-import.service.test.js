...
describe('Property Import Service publish gate', () => {
    ...
    test('preserves mapping metadata when saving and marks the draft ready after approval', async () => {
        ...
        const result = await propertyImport_service_1.propertyImportService.saveDraft('company-1', 'draft-1', 'user-1', {
            draftData: {
                name: 'Sunrise Residences',
                import_mapping: {
                    source_type: 'brochure',
    ...
    test('rejects publishing before extraction is complete', async () => {
        ...
        await expect(propertyImport_service_1.propertyImportService.publishDraft('company-1', 'draft-1', 'user-1', false)).rejects.toMatchObject({
    ...
    test('publishes once extraction is complete and the draft is publish_ready', async () => {
        ...
        const result = await propertyImport_service_1.propertyImportService.publishDraft('company-1', 'draft-1', 'user-1', false);
...
//# sourceMappingURL=property-import.service.test.js.map