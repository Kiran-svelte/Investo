...
const greenapi_whatsapp_provider_1 = require("../../services/whatsapp/providers/greenapi-whatsapp.provider");
...
describe('GreenApiWhatsAppProvider (outbound)', () => {
    ...
    const provider = new greenapi_whatsapp_provider_1.GreenApiWhatsAppProvider({ apiUrl });
    const companyConfig = {
        phoneNumberId: '',
        accessToken: '',
        verifyToken: '',
...
//# sourceMappingURL=whatsapp-greenapi-provider.test.js.map