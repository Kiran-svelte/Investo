...
describe('Geocoding Service', () => {
    beforeEach(() => {
        jest.clearAllMocks();
        (0, geocoding_service_1.clearGeocodeCache)();
    });
    afterEach(() => {
    ...
    describe('geocodeAddress (Nominatim)', () => {
        it('should geocode a valid address successfully', async () => {
            ...
            const result = await geocoding_service_1.geocodingService.geocodeAddress('Whitefield, Bangalore, India');
        ...
        it('should return null for address not found', async () => {
            ...
            const result = await geocoding_service_1.geocodingService.geocodeAddress('NonExistentPlace123456');
            expect(result).toBeNull();
        });
        it('should handle API errors gracefully', async () => {
            mockFetch.mockRejectedValueOnce(new Error('Network error'));
            const result = await geocoding_service_1.geocodingService.geocodeAddress('Whitefield, Bangalore');
            expect(result).toBeNull();
        });
        ...
        it('should cache results for repeated queries', async () => {
            ...
            // First call - hits API
            const result1 = await geocoding_service_1.geocodingService.geocodeAddress('Whitefield, Bangalore');
            expect(result1).not.toBeNull();
            expect(mockFetch).toHaveBeenCalledTimes(1);
            // Second call - should use cache
            const result2 = await geocoding_service_1.geocodingService.geocodeAddress('Whitefield, Bangalore');
        ...
        it('should normalize address for cache key', async () => {
            ...
            // First call
            await geocoding_service_1.geocodingService.geocodeAddress('  Whitefield, Bangalore  ');
            expect(mockFetch).toHaveBeenCalledTimes(1);
        ...
        it('should set correct confidence based on importance', async () => {
            ...
            let result = await geocoding_service_1.geocodingService.geocodeAddress('HighConf');
            expect(result.confidence).toBe('high');
            (0, geocoding_service_1.clearGeocodeCache)();
            // Medium importance
            mockFetch.mockResolvedValueOnce({
            ...
            result = await geocoding_service_1.geocodingService.geocodeAddress('MedConf');
            ...
            result = await geocoding_service_1.geocodingService.geocodeAddress('LowConf');
    ...
    describe('getGeocodeStats', () => {
        it('should return cache statistics', async () => {
            ...
            // Make some requests
            await geocoding_service_1.geocodingService.geocodeAddress('Address1');
            await geocoding_service_1.geocodingService.geocodeAddress('Address2');
            await geocoding_service_1.geocodingService.geocodeAddress('Address1'); // Cache hit
            const stats = (0, geocoding_service_1.getGeocodeStats)();
    ...
    describe('clearGeocodeCache', () => {
        it('should clear all cached results', async () => {
            ...
            await geocoding_service_1.geocodingService.geocodeAddress('TestAddress');
            expect((0, geocoding_service_1.getGeocodeStats)().size).toBe(1);
            (0, geocoding_service_1.clearGeocodeCache)();
            expect((0, geocoding_service_1.getGeocodeStats)().size).toBe(0);
    ...
    describe('Edge Cases', () => {
        it('should handle empty address string', async () => {
            const result = await geocoding_service_1.geocodingService.geocodeAddress('');
            expect(result).toBeNull();
        ...
        it('should handle special characters in address', async () => {
            ...
            await geocoding_service_1.geocodingService.geocodeAddress('MG Road, #123, Near Temple');
            expect(mockFetch).toHaveBeenCalledTimes(1);
        ...
        it('should handle very long addresses', async () => {
            ...
            const result = await geocoding_service_1.geocodingService.geocodeAddress(longAddress);
            expect(result).not.toBeNull();
        });
        it('should handle malformed API response', async () => {
            ...
            const result = await geocoding_service_1.geocodingService.geocodeAddress('Test Address');
...
describe('Integration: Property Route Geocoding', () => {
    ...
    it('should support geocoding workflow for property creation', async () => {
        ...
        // Build address
        const address = (0, geocoding_service_1.buildAddressFromProperty)(propertyData);
        ...
        // Geocode
        const coords = await geocoding_service_1.geocodingService.geocodeAddress(address);
