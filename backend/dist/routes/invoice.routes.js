...
router.get('/', async (req, res) => {
    try {
        ...
        logger_1.default.error('Failed to fetch invoices', { error: err.message });
...
router.get('/:id', async (req, res) => {
    try {
        ...
        logger_1.default.error('Failed to fetch invoice', { error: err.message });
 ...
 */
router.post('/', (0, rbac_1.hasRole)('super_admin', 'company_admin'), (0, audit_1.auditLog)('create', 'invoices'), async (req, res) => {
    try {
        const { user } = req;
        const { company_id, amount, tax = 0, period_start, period_end, due_date, notes, } = req.body;
        ...
        logger_1.default.info('Invoice created', {
        ...
        logger_1.default.error('Failed to create invoice', { error: err.message });
 ...
 */
router.put('/:id/pay', (0, rbac_1.hasRole)('super_admin', 'company_admin'), (0, audit_1.auditLog)('update', 'invoices'), async (req, res) => {
    try {
        const { user } = req;
        const { id } = req.params;
        ...
        logger_1.default.info('Invoice marked as paid', {
            invoiceId: id,
            paymentMethod: payment_method,
            paymentRef: payment_ref,
        });
        ...
        logger_1.default.error('Failed to mark invoice as paid', { error: err.message });
...
router.get('/:id/download', async (req, res) => {
    try {
        ...
        const settings = invoice.company.settings || {};
        ...
        logger_1.default.error('Failed to download invoice', { error: err.message });
 ...
 */
function generateInvoicePDF(invoice, companySettings) {
 ...
 * Super admin only
 */
router.post('/generate-monthly', (0, rbac_1.hasRole)('super_admin'), (0, audit_1.auditLog)('create', 'invoices'), async (req, res) => {
    try {
        const now = new Date();
        ...
        logger_1.default.info('Monthly invoices generated', {
        ...
        logger_1.default.error('Failed to generate monthly invoices', { error: err.message });
