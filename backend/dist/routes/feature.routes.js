...
router.get('/', (0, rbac_1.authorize)('ai_settings', 'read'), async (req, res) => {
    try {
        ...
        const dbFeatures = await prisma_1.default.companyFeature.findMany({
            where: { companyId },
        });
        ...
        logger_1.default.error('Failed to list features', { error: err.message });
 ...
 */
router.put('/:key', (0, rbac_1.authorize)('ai_settings', 'update'), async (req, res) => {
    try {
        const companyId = (0, tenant_1.getCompanyId)(req);
        ...
        const feature = await prisma_1.default.companyFeature.upsert({
        ...
        logger_1.default.error('Failed to update feature', { error: err.message });
 ...
 */
router.put('/', (0, rbac_1.authorize)('ai_settings', 'update'), async (req, res) => {
    try {
        const companyId = (0, tenant_1.getCompanyId)(req);
        ...
        logger_1.default.error('Failed to bulk update features', { error: err.message });
