...
exports.detectConversionIntents = detectConversionIntents;
function detectConversionIntents(message) {
    ...
    return {
        ...
        urgentPossession: /\b(1 month|one month|immediate|immediately|ready to move|rtm|urgent possession|asap)\b/i.test(m),
