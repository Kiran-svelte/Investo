...
const config = {
  ...
  storage: {
    ...
    propertyUploadMaxBytes: parseInt(process.env.PROPERTY_UPLOAD_MAX_BYTES || String(25 * 1024 * 1024), 10),
    allowedMimeTypes: (process.env.PROPERTY_ALLOWED_MIME_TYPES || 'image/jpeg,image/png,image/webp,application/pdf,video/mp4').split(','),
  },
