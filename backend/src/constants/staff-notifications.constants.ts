...
export const STAFF_WHATSAPP_NOTIFICATIONS = [
  ...
  { id: 'morning_briefing', recipient: 'sales_agent', trigger: '15-min cron at company working_hours.start + CHECK IN reply', sender: 'cron-scheduler.processStaffShiftBriefings / staffShiftBriefing' },
  { id: 'eod_summary', recipient: 'sales_agent', trigger: '15-min cron at company working_hours.end + CHECK OUT reply', sender: 'cron-scheduler.processStaffShiftBriefings / staffShiftBriefing' },
