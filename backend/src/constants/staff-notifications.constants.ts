...
export const STAFF_WHATSAPP_NOTIFICATIONS = [
  ...
  { id: 'morning_briefing', recipient: 'sales_agent', trigger: 'Daily cron', sender: 'cron-scheduler.sendMorningBriefings' },
  { id: 'eod_summary', recipient: 'sales_agent', trigger: 'Daily cron', sender: 'cron-scheduler.sendEndOfDaySummaries' },
